...
// Słownik odmian dla jednostek [Dla 1, Dla 2-4, Dla 5+ i reszty]
...
// Funkcja pomocnicza: Zwraca poprawną formę słowa (np. 1 Szklanka, 5 Szklanek)
...
function calculate() {
    ...
    // Wyświetlanie: Używamy nowej funkcji getUnitLabel
...
function updateRecipe() {
    ...
    items.forEach(item => {
        ...
        // 2. Zmiana nazwy jednostki (Odmiana)
